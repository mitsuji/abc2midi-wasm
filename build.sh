...
# abc2midi
#
emcc -c -O3 -DANSILIBS deps/abcmidi/parseabc.c    -obuild/parseabc.o
emcc -c -O3 -DANSILIBS deps/abcmidi/store.c       -obuild/store.o
emcc -c -O3 -DANSILIBS deps/abcmidi/genmidi.c     -obuild/genmidi.o
emcc -c -O3 -DANSILIBS deps/abcmidi/midifile.c    -obuild/midifile.o
emcc -c -O3 -DANSILIBS deps/abcmidi/queues.c      -obuild/queues.o
emcc -c -O3 -DANSILIBS deps/abcmidi/parser2.c     -obuild/parser2.o
emcc -c -O3 -DANSILIBS deps/abcmidi/stresspat.c   -obuild/stresspat.o
emcc -c -O3 -DANSILIBS deps/abcmidi/music_utils.c -obuild/music_utils.o
emcc -O3 -obuild/abc2midi.js build/parseabc.o build/store.o build/genmidi.o build/midifile.o build/queues.o build/parser2.o build/stresspat.o build/music_utils.o -sEXPORTED_RUNTIME_METHODS=FS,callMain -sMODULARIZE -sEXPORT_NAME=createAbc2Midi -sINVOKE_RUN=0
...
emcc -O3 -obuild/midi2raw.js build/common.o build/instrum.o build/mix.o build/output.o build/playmidi.o build/readmidi.o build/resample.o build/stream.o build/tables.o build/timidity.o build/midi2raw.o -sEXPORTED_RUNTIME_METHODS=FS,callMain -sMODULARIZE -sEXPORT_NAME=createMidi2Raw -sINVOKE_RUN=0
...
emcc -O3 -obuild/abcm2ps.js build/abcm2ps.o build/abcparse.o build/buffer.o build/deco.o build/draw.o build/format.o build/front.o build/glyph.o build/music.o build/parse.o build/subs.o build/svg.o build/syms.o -sEXPORTED_RUNTIME_METHODS=FS,callMain -sMODULARIZE -sEXPORT_NAME=createAbcm2Ps -sINVOKE_RUN=0
